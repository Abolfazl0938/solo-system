کاملاً درسته؛ پیام قبلی در نیمه قطع شد. این یک نسخه کامل، بی‌نقص و قدم‌به‌قدم بر اساس همان قالبی است که خواستی. تمام مراحل نصب، نحوه استفاده کلید به کلید (Step-by-Step)، سناریوی اجرای منو، تست‌ها و ساختار پروژه داخلش به زبان انگلیسی استاندارد آورده شده است.

کل متن زیر را کپی کن و در فایل `README.md` در ریشه پروژه‌ات قرار بده:
